...
const App = () => {
  ...
  return (
    <div className="2xl:grid 2xl:grid-cols-12 xl:grid xl:grid-cols-12 lg:flex lg:flex-col lg:justify-center lg:items-center lg:container lg:mx-auto lg:py-[5rem] lg:relative md:flex md:flex-col md:justify-center md:items-center md:container md:mx-auto md:relative md:py-[3rem] sm:flex sm:flex-col sm:justify-center sm:items-center sm:container sm:mx-auto sm:relative sm:py-[3rem] xs:flex xs:flex-col xs:justify-center xs:items-center xs:container xs:mx-auto xs:relative xs:py-[3rem] xxs:flex xxs:flex-col xxs:justify-center xxs:items-center xxs:container xxs:mx-auto xxs:relative xxs:py-[3rem] xxs:px-0">
      <LeftSection />
      <MiddleSection />
      <RightSection />
