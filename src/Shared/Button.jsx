...
const Button = ({text}) => {
	...
	return (
		<button
			...
			className="border-[1px] border-[#27e68a] my-4 py-4 mx-6 rounded-full bg-[#27e68a] group hover:bg-primary flex justify-center items-center gap-4 hover:transition-all hover:duration-300 hover:ease-in-out"
		>
