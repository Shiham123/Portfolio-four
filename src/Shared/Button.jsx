...
const Button = ({text}) => {
	...
	return (
		<button
			...
			className="border-[1px] border-[#27e68a] 2xl:mb-12 xl:mb-6 2xl:py-4 xl:py-3 lg:mb-8 lg:py-3 md:py-3 md:my-4 sm:py-4 sm:my-6 xs:my-6 xs:py-4 mx-10 rounded-custom bg-[#27e68a] group hover:bg-primary flex justify-center items-center gap-4 hover:transition-all hover:duration-300 hover:ease-in-out"
		>
