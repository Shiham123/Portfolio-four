...
const RightSection = () => {
	return (
		<section className="2xl:col-span-1 2xl:fixed 2xl:right-[2%] 2xl:top-0 xl:col-span-1 xl:fixed xl:right-[2%] xl:top-0 lg:hidden md:hidden sm:hidden xs:hidden xxs:hidden">
