		...
		<div className="2xl:px-[7%] md:px-[10%] sm:px-[10%] lg:px-[10%] xl:px-[10%] xxs:px-[10%] mt-[15%] my-[10rem] rounded-[20px] relative">
			...
			{status === "succeeded" ? (
				<>
					...
					<div className="swiper-button-prev-custom absolute bottom-[-4rem] left-[6rem] border-2 border-primaryBorder p-3 rounded-[100%] cursor-pointer">
						<svg
							width="20px"
							height="20px"
							viewBox="-4.5 0 20 20"
					...
					<div className="swiper-button-next-custom absolute bottom-[-4rem] left-[10rem] border-2 border-primaryBorder p-3 rounded-[100%] cursor-pointer">
						<svg
							width="20px"
							height="20px"
							viewBox="-4.5 0 20 20"
