...
const DrawerComponents = () => {
	...
	return (
		<div
			...
			className="2xl:hidden xl:hidden absolute border-primaryBorder group hover:border-secondary lg:top-0 lg:-right-[10%] md:top-0 md:-right-[30%] cursor-pointer border-[2px] rounded-custom p-2 transition-all duration-300 ease-in-out"
		>
			<HiMiniBars2
				size={30}
