	...
	return (
		<>
			...
			{isSidebarOpen && (
				<div
					id="sidebar"
					className={`2xl:hidden xl:hidden fixed top-0 right-0 h-full bg-bgSidebar bg-opacity-90 flex flex-col justify-center items-center lg:w-[35%] md:w-[35%] sm:w-[45%] xs:w-[70%] xxs:w-[70%] z-20 ${animateClass} border-l-[1px] border-secondary`}
				>
