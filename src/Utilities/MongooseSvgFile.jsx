...
const MongooseSvgFile = () => {
	const {fillColor, id} = useSelector((state) => state.icon)
	return (
		<svg width="170px" height="120px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
			<path
				...
				style={{fill: `${id === 16 ? fillColor : "#565656"}`}}
			/>
		</svg>
	)
}

export default MongooseSvgFile
